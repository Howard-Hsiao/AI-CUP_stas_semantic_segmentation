...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes=('stas', ),
        ann_file='data/SEG_Train_Datasets/coco/STAS_train.json',
        img_prefix='data/SEG_Train_Datasets/Train_Images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
            dict(
    ...
    val=dict(
        type='CocoDataset',
        classes=('stas', ),
        ann_file='data/SEG_Train_Datasets/coco/STAS_val.json',
        img_prefix='data/SEG_Train_Datasets/Train_Images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
    ...
    test=dict(
        type='CocoDataset',
        classes=('stas', ),
        ann_file='data/SEG_Train_Datasets/coco/STAS_test.json',
        img_prefix='data/SEG_Train_Datasets/Test_Images/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
