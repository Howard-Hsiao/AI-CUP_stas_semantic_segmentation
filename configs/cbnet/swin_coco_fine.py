...
log_level = 'INFO'
load_from = 'work_dirs/swin_custom_v14-1/epoch_10.pth'
...
# CUDA_VISIBLE_DEVICES=2 python tools/test.py configs/cbnet/swin_coco_fine.py work_dirs/swin_coco_v5/epoch_4.pth --out result_coco.json --show --show-dir ckpt/coco_result --coco
# CUDA_VISIBLE_DEVICES=2 python tools/test.py configs/cbnet/swin_coco_fine.py work_dirs/swin_coco_v5/epoch_4.pth --eval bbox segm
